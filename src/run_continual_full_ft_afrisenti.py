...
# sys.path.append(".")
# sys.path.append("../")
sys.path.append(os.path.abspath(os.path.join(os.path.dirname(__file__), ".."))) #Nhitny
...
if __name__ == "__main__":
    ...
    # # Khởi tạo wandb
    # wandb.init(
    #     entity="truongnguyenyennhi-sgu",  # Tên entity của bạn trên wandb
    #     project="MoCL-AfriSent",          # Tên project trên wandb
    #     config={
    #         "learning_rate": training_args.learning_rate,
    #         "batch_size": training_args.per_device_train_batch_size,
    #         "epochs": training_args.num_train_epochs,
    #         "dropout": model_args.hidden_dropout_prob,
    #         "seed": training_args.seed,
    #     },
    # )
    # # Nhitny Đặt tên cho tiến trình
    # import setproctitle
    # setproctitle.setproctitle(f"MoCL-AfriSent-{training_args.seed}")
    # wandb.finish()
    # #Nhitny wandb