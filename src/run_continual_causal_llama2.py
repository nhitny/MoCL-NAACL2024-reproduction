...
#Nhitny
# import torch
# torch.cuda.set_per_process_memory_fraction(0.5, 0)  # Giới hạn 50% bộ nhớ GPU
#Nhitny
...
if __name__ == "__main__":
    ...
    dataset_dir = "/workspace/nhitny/mcs/MoCL-NAACL-2024/datasets/mtl15"  # Nhitny
    ...
    # Nhitny thêm bnb_config (quantization 8-bit)
    from transformers import BitsAndBytesConfig
    import torch
    bnb_config = BitsAndBytesConfig(
    load_in_8bit=True,  # hoặc False nếu bạn muốn dùng 4-bit sau này
    ...
    model = LlamaContinualForCausalLM.from_pretrained(
        ...
        # quantization_config=bnb_config,  # Nhitny thêm bnb_config (quantization 8-bit)
        torch_dtype=torch.float16,       # Nhitny thêm bnb_config (quantization 8-bit)
    )
